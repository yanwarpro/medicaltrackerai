...
export const CHECKLIST_ITEMS: ChecklistItem[] = [
  ...
  { id: 'urea', category: 'Kidney', name: 'Urea / BUN', normalizedName: 'urea', description: 'Blood Urea Nitrogen / Ureum' },
  ...
  { id: 'uric_acid', category: 'Kidney', name: 'Asam Urat (Uric Acid)', normalizedName: 'uric acid', description: 'Kadar asam urat' },
...
export const LAB_NORMALIZATION_MAP: Record<string, string> = {
  ...
  'klorida': 'chloride',
  'chlorida': 'chloride',
  'klorida darah': 'chloride',
  'chlorida darah': 'chloride',
  'cl': 'chloride',
  'calcium': 'calcium',
  'kalsium': 'calcium',
  'ca': 'calcium',
...
export const PARAM_OPTIONS = [
  ...
  { label: 'Hematokrit', normalized: 'hematocrit', unit: '%', refLow: 37, refHigh: 48 },
  { label: 'Eritrosit (RBC)', normalized: 'rbc', unit: '10⁶/µL', refLow: 4.0, refHigh: 5.5 },
  { label: 'MCV', normalized: 'mcv', unit: 'fL', refLow: 80, refHigh: 100 },
  { label: 'MCH', normalized: 'mch', unit: 'pg', refLow: 27, refHigh: 32 },
  { label: 'MCHC', normalized: 'mchc', unit: 'g/dL', refLow: 32, refHigh: 36 },
  { label: 'Ferritin', normalized: 'ferritin', unit: 'ng/mL', refLow: 12, refHigh: 150 },
  { label: 'Serum Iron (Fe)', normalized: 'serum iron', unit: 'µg/dL', refLow: 60, refHigh: 170 },
  { label: 'TIBC', normalized: 'tibc', unit: 'µg/dL', refLow: 240, refHigh: 450 },
  { label: 'TSAT', normalized: 'tsat', unit: '%', refLow: 20, refHigh: 50 },
  { label: 'Retikulosit', normalized: 'reticulocyte', unit: '%', refLow: 0.5, refHigh: 2.5 },
  { label: 'Vitamin B12', normalized: 'vitamin b12', unit: 'pg/mL', refLow: 200, refHigh: 900 },
  { label: 'Asam Folat', normalized: 'folate', unit: 'ng/mL', refLow: 3.0, refHigh: 17.0 },
  { label: 'Kreatinin', normalized: 'creatinine', unit: 'mg/dL', refLow: 0.5, refHigh: 1.1 },
  { label: 'eGFR', normalized: 'egfr', unit: 'mL/min/1.73m²', refLow: 90, refHigh: 120 },
  { label: 'Urea / BUN', normalized: 'urea', unit: 'mg/dL', refLow: 7, refHigh: 20 },
  { label: 'Kalium (K)', normalized: 'potassium', unit: 'mmol/L', refLow: 3.5, refHigh: 5.0 },
  { label: 'Natrium (Na)', normalized: 'sodium', unit: 'mmol/L', refLow: 135, refHigh: 145 },
  { label: 'Klorida (Cl)', normalized: 'chloride', unit: 'mmol/L', refLow: 96, refHigh: 106 },
  { label: 'Asam Urat', normalized: 'uric acid', unit: 'mg/dL', refLow: 2.4, refHigh: 6.0 },
  { label: 'SGOT (AST)', normalized: 'ast', unit: 'U/L', refLow: 0, refHigh: 35 },
  { label: 'SGPT (ALT)', normalized: 'alt', unit: 'U/L', refLow: 0, refHigh: 35 },
  { label: 'Albumin', normalized: 'albumin', unit: 'g/dL', refLow: 3.5, refHigh: 5.2 },
  { label: 'Bilirubin Total', normalized: 'bilirubin', unit: 'mg/dL', refLow: 0.2, refHigh: 1.2 },
  { label: 'Glukosa (GDS)', normalized: 'glucose', unit: 'mg/dL', refLow: 70, refHigh: 140 },
